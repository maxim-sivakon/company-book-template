		...
		<div id="bx-soa-order" class="row bx-<?=$arParams['TEMPLATE_THEME']?>" style="opacity: 0">
			...
			<div class="col-sm-9 bx-soa">
				...
				<div id="bx-soa-region" data-visited="false" class="bx-soa-section bx-active">
					...
					<div class="bx-soa-section-inrotext container-fluid">
Стоимость доставки курьером по Москве 450 руб.<br>
Стоимость доставки курьером по Московской области в радиусе 20 км от МКАД - 550 руб.<br>
						<i>Если ваш населенный пункт не входит в зону доставки Вы можете оформить заказ у наших партнёров в <noindex><a rel="nofollow" target="_blank" href="https://www.eapteka.ru/goods/drugs/gasroenterology/dysbacteriosis/biovestin_bio_vesta/">Еаптеке</a></noindex> с доставкой на дом или самовывозом из ближайшей к вам точки самовывоза. </i>
					</div>
					<div class="bx-soa-section-content container-fluid"></div>
				</div>
				...
				<a href="/soglasiya-ob-obrabotke-personalnykh-dannykh/" class="info-text">
					*Нажимая кнопку «Оформить заказ», я даю свое согласие на обработку моих персональных данных, в
					соответствии с
					Федеральным законом от&nbsp;27.07.2006 года №152-ФЗ «О персональных данных», на условиях и для целей,
					определенных в Согласии
...
<script>
	document.addEventListener('DOMContentLoaded', () => {
		document.querySelector(".bx-ui-sls-fake")
