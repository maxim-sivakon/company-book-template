...
<script id="basket-item-template" type="text/html">
	<div id="cart_item_{{ID}}">
		<div class="hidden_cart_item" data-entity="basket-item" data-id="{{ID}}">
			<img alt="{{NAME}}" src="{{{IMAGE_URL}}}{{^IMAGE_URL}}<?=$templateFolder?>/images/no_photo.png{{/IMAGE_URL}}" class="product_icon">
			<div class="name" data-entity="basket-item-name">{{NAME}}</div>
			<div class="price">
				{{#SHOW_DISCOUNT_PRICE}}
					<div class="old">
						{{{FULL_PRICE_FORMATED}}}
			...
			<div class=" quantity basket-item-block-amount{{#NOT_AVAILABLE}} disabled{{/NOT_AVAILABLE}}"
				...
				<div src="./Images/Hits/minus.png" alt="minus" class='img minus' data-entity="basket-item-quantity-minus"></div>
				
				<div class="basket-item-amount-filed-block">
					<input type="text" class="basket-item-amount-filed itemsNumber2" value="{{QUANTITY}}"
						{{#NOT_AVAILABLE}} disabled="disabled"{{/NOT_AVAILABLE}}
						data-value="{{QUANTITY}}" data-entity="basket-item-quantity-field"
						id="basket-item-quantity-{{ID}}">
				</div>
				<div src="./Images/Hits/plus.png" alt="plus" class='img plus' data-entity="basket-item-quantity-plus"></div>
				{{#SHOW_LOADING}}
			...
			<div class="sum" id="basket-item-sum-price-{{ID}}">{{{SUM_PRICE_FORMATED}}}</div>
			<span class="basket-item-actions-remove" data-entity="basket-item-delete">
				<img src="/local/templates/.default/biovestin_markup/Images/cart/remove_icon.svg" alt="remove" class="remove">
			</span>
		</div>
		<hr>
	</div>
