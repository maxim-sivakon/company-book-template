...
<script id="basket-item-template" type="text/html">
	<div class="cart-product__item cart{{PRODUCT_ID}}" id="cart_item_{{ID}}" data-entity="basket-item" data-id="{{ID}}">
		<div class="cart-product__img">
			<img alt="{{NAME}}" src="{{{IMAGE_URL}}}{{^IMAGE_URL}}<?=$templateFolder?>/images/no_photo.png{{/IMAGE_URL}}">
		</div>
		<div class="cart-product-title" data-entity="basket-item-name">
			{{NAME}}
		</div>
		
		<div class="cart-product__counter product__counter {{#NOT_AVAILABLE}} disabled{{/NOT_AVAILABLE}}"
			data-entity="basket-item-quantity-block">
			<div class="cart-product__counter-btn product__counter__btn" data-entity="basket-item-quantity-minus">-</div>
						
			
				<input type="text" class="cart-product__counter-btn product__counter__value" value="{{QUANTITY}}"
					{{#NOT_AVAILABLE}} disabled="disabled"{{/NOT_AVAILABLE}}
					data-value="{{QUANTITY}}" data-entity="basket-item-quantity-field"
					id="basket-item-quantity-{{ID}}">
			
			<div class="cart-product__counter-btn product__counter__btn" data-entity="basket-item-quantity-plus">
				+
			</div>
			{{#SHOW_LOADING}}
		...
		<?/*<div class="price">
			...
			<div class="new" id="basket-item-price-{{ID}}">
				{{{PRICE_FORMATED}}}
			</div>
		</div>
		*/?>
		<div class="cart-product__pryse-wrapper">
			{{#SHOW_DISCOUNT_PRICE}}
				<span class="cart-product__pryse-old" id="basket-item-sum-price-old-{{ID}}">
					{{{SUM_FULL_PRICE_FORMATED}}}
				</span>
			{{/SHOW_DISCOUNT_PRICE}}

			<span class="cart-product__pryse-nev" id="basket-item-sum-price-{{ID}}">
				{{{SUM_PRICE_FORMATED}}}
			</span>
		</div>
		<span class="cart-product__del" data-entity="basket-item-delete"><svg width="22" height="22" viewBox="0 0 22 22" fill="none"
				xmlns="http://www.w3.org/2000/svg">
				<path fill-rule="evenodd" clip-rule="evenodd"
					d="M11 22C4.92487 22 0 17.0751 0 11C0 4.92487 4.92487 0 11 0C17.0751 0 22 4.92487 22 11C22 17.0751 17.0751 22 11 22ZM11 20C15.9706 20 20 15.9706 20 11C20 6.02944 15.9706 2 11 2C6.02944 2 2 6.02944 2 11C2 15.9706 6.02944 20 11 20ZM7.70712 15.7071L11 12.4142L14.2929 15.7071L15.7071 14.2929L12.4142 11L15.7071 7.70711L14.2929 6.29289L11 9.58579L7.70712 6.29289L6.29291 7.70711L9.5858 11L6.29291 14.2929L7.70712 15.7071Z"
					fill="#CAD6E0" />
			</svg>
		</span>
	</div>
