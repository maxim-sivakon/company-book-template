...
$arResult['OFFERS_SELECTED'] = $_REQUEST['pid'] == 109 ? 0 : 1;

foreach ($arResult['OFFERS'] as $key => $offer) {
    if ($offer['ID'] == $_REQUEST['pid']) {
...
$APPLICATION->IncludeComponent("yandex.metrika:detail", "", array("PRODUCT_ID" => $mainId), $component);
...
$arFilter = Array("IBLOCK_ID"=>21, "ACTIVE_DATE"=>"Y", "ACTIVE"=>"Y", "ID" => $_REQUEST['pid']);
...
<section class="product-cart product" style="background-image: url(<?=SITE_TEMPLATE_PATH?>/moscow/images/top-bg.jpg); background-repeat: no-repeat; background-position:center;">
    <div class="container">
		...
		<div class='row' id="<?=$itemIds['ID']?>">
			<div class="col">
				<div class="slider-wrapper">
					<div class="slider-box" data-entity="images-container">
						<?foreach($arProps['MORE_PHOTO']['VALUE'] as $photo):?>
							<div class="slider-box__item" data-entity="image">
			...
			<div class="col-md-6">
				<div class="cart-box__content">
					...
					<div class="cart-box__box">
						<?foreach($arProps['SPECIFICATION']["VALUE"] as $key => $value):?>
							<span class="cart-box_desc-item">
								<span class="card-desc__weight"><?=$arProps['SPECIFICATION']["DESCRIPTION"][$key]?></span>
								<?=$value?>
							</span>
						<?endforeach;?>
					</div>
		...
		<div class="row dosage__wrapper">
			<div class="col-lg-6">
				<a href="/dozirovka-i-skhema-priema/" class="dosage dosage--bg">
...
<section class="info">
	<div class="container">
		<div class="row info__inner">
			<?foreach($arProps['ADVANTAGES']["VALUE"] as $key => $value):?>
				<div class="col-md-6 border-line ">
					<div class="info__wrapper">
						<div class="info__title">
							<?=$arProps['ADVANTAGES']["DESCRIPTION"][$key]?>
						</div>
...
<?}?>
		<div class="row info__download">
			<div class="col-md-6">
				<a class="buy__link" href="<?=CFile::GetPath($arProps["FILE_INSTR"]["VALUE"]);?>" download>
			...
			<div class="col-md-6">
				<a class="buy__link" href="<?=CFile::GetPath($arProps["FILES_SVID"]["VALUE"]);?>" download>
					<span class="buy__link-wrapper">
						<span>
							<img src="<?=SITE_TEMPLATE_PATH?>/moscow/images/icon/pdf.png" alt=""></span>
